...
class ProductPropertiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create product_property" do
    assert_difference('ProductProperty.count') do
      post product_properties_url, params: { product_property: { spree_product_property_id_id: @product_property.spree_product_property_id_id, spree_user_id_id: @product_property.spree_user_id_id, value: @product_property.value } }
    end
  ...
  test "should update product_property" do
    patch product_property_url(@product_property), params: { product_property: { spree_product_property_id_id: @product_property.spree_product_property_id_id, spree_user_id_id: @product_property.spree_user_id_id, value: @product_property.value } }
