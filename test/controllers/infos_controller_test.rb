...
class InfosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create info" do
    assert_difference('Info.count') do
      post infos_url, params: { info: { dob: @info.dob, gender: @info.gender, name: @info.name, phone: @info.phone, profiles_id: @info.profiles_id } }
    end
  ...
  test "should update info" do
    patch info_url(@info), params: { info: { dob: @info.dob, gender: @info.gender, name: @info.name, phone: @info.phone, profiles_id: @info.profiles_id } }
