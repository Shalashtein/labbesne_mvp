# -*- encoding: utf-8 -*-
# stub: solidus_paypal_commerce_platform 0.2.2 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<solidus_support>.freeze, [">= 0.5.1", "< 1"])
      ...
      s.add_dependency(%q<solidus_support>.freeze, [">= 0.5.1", "< 1"])
