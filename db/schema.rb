...
ActiveRecord::Schema.define(version: 2021_02_13_160357) do
  ...
  create_table "outfits", force: :cascade do |t|
    ...
    t.datetime "updated_at", precision: 6, null: false
    t.bigint "spree_user_id", null: false
    t.index ["spree_user_id"], name: "index_outfits_on_spree_user_id"
  end
  ...
  create_table "product_outfits", force: :cascade do |t|
    t.bigint "spree_product_id", null: false
